...
public:
    ...
    dji_sdk_read_cam::AprilTagDetection detection_points;
...
//Add a callback for apriltag_detetion
    void apriltag_datection_callback ( const dji_sdk_read_cam::AprilTagPose & pose ) // geometry_msgs::PoseWithCovarianceStamped &msg)
    {
#ifndef PID_USED
        this->flight_x = pose.z;
        this->flight_y = -pose.y;
#endif
        this->flight_x_tag = pose.z;
        this->flight_y_tag = -pose.y;
        this->flight_gimbal_angle_pitch_inc = pose.gimbal_pitch_inc;// = atan(detection.z/(detection.x+0.00000001))*57.3;//To angle
        this->flight_norm = pose.norm;
        this->flight_height = pose.height_with_gimbal;
        this->yaw_from_apriltag = pose.yaw;
    ...
    void received_detectionPoints_callback ( const dji_sdk_read_cam::AprilTagDetection & detectionPoints )//use const!
    {
...
//#else
        ...
        apriltag_detection_subscriber = nh.subscribe ( "apriltag_detection/AprilTagPose",10,&DJIDrone::apriltag_datection_callback,this );

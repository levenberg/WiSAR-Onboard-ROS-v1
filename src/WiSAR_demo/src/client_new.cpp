...
int main ( int argc, char **argv )
{
    ...
    int waitforLandingTagShowup = 1000;
    ...
    node_priv.param<int>("wait_for_landing_tag_showup",waitforLandingTagShowup,1200);
    ros::NodeHandle nh; 
    ...
    waypoint0.latitude = 22.5428000;   //43.2307347;
    waypoint0.longitude = 113.9589000;  //-75.41944035;
    ...
    double longitude_return;
    double latitude_return;
    longitude_return = drone->global_position.longitude;
    latitude_return = drone->global_position.latitude;
    //longitude_return =-75.4180322;
    //latitude_return =43.2299043;
        ...
        case 'q':
        {
            if ( takeoff_wait_count<max_takeoff_waitcount ) //Take off, waypoint-fly to a fixed location and then descend to 3m
            {
               // writeF<<"take off process..."<<start_yaw<<endl;
                ...
                longitude_return =drone->global_position.longitude;//-75.4180322;
                latitude_return =drone->global_position.latitude;//43.2299043;
             ...
             //   latitude_start = drone->global_position.latitude;
                ...
                case 0:
                    ...
                    waypointtask=Waypoint_mission ( drone->global_position.latitude,drone->global_position.longitude,initial_descending_height_at_search,waypoint0.latitude,waypoint0.longitude,waypoint0.altitude );
                ...
                case 2:
                    ...
                    if ( start_searching.data==true )
                    {
                        ...
                        pitch_rate = drone->gimbal.pitch>-35? -50: ( drone->gimbal.pitch>-89? pitch_rate:50 );
        ...
        case 'd':
        {
            ...
            case 2:
                ...
                else
                {
                    ...
                    waypointtask.mission_waypoint.clear();
                    waypointtask=Waypoint_mission ( drone->global_position.latitude,drone->global_position.longitude,initial_descending_height_at_search,latitude_return,longitude_return,initial_descending_height_at_search );
                    drone->mission_waypoint_upload ( waypointtask );
                    drone->mission_start();
                    sleep ( 2 );
                    //writeF<<"waypoint. state=0, navigation..."<<drone->waypoint_mission_push_info.current_status<<endl;
            ...
            case 100://
                ...
                if ( numOfDetections<1 )
                {
                    ...
                    waitforLandingTagShowup--;
                    if(600==waitforLandingTagShowup)
		    {
		      int ttime=0;
                        float angle_temp = start_yaw>0?(start_yaw*57.2958-180):(start_yaw*57.2958+180);
                        while ( drone->transparentdata.data.at ( 0 ) != 'a'&& ttime++<200 )
                        {
                            drone->attitude_control ( 0x93,0,0,tracking_flight_height,angle_temp );
		    ...
		    if(0==waitforLandingTagShowup)
                    {
		       
                        waypointtask.mission_waypoint.clear();
                        waypointtask=Waypoint_mission (latitude_return,longitude_return,tracking_flight_height,43.229798,-75.4183286,tracking_flight_height );
                        drone->mission_waypoint_upload ( waypointtask );
                        drone->mission_start();
                        ...
                        {
                            ros::spinOnce();
                             flying_height_control_tracking -= descending_height_delta*3;
